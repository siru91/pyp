    ...
    return (
      <div className="a main-container">
        <div className="a container">
          <div id="intro-container" data-aos="fade-in" data-aos-delay="100">
            ...
            <div className="text-holder" data-aos="fade-in">
              ...
              <div className="text 02" data-aos="fade-in" data-aos-delay="1500">
                그리고 엔지니어입니다.
              </div>
            </div>
          </div>
          ...
          <div data-aos="fade-in" data-aos-delay="300">
            ...
            있습니다.
            <br></br>
            GUI 제작을 위한 그래픽 툴을, UX 구현을 위한 프로토타이핑 툴을 이용해
            왔습니다.
          </div>
          ...
          <div data-aos="fade-in" data-aos-delay="300">
            ...
            <br></br>
            새로운 기술에 깨어있으려 노력하며 배움에 거부감이 적다고 자부합니다.
            <br></br>
        ...
        <div className="container">
          <button class="collapsible" data-aos="fade-down" data-aos-delay="300">
            자세한 정보
          </button>
          <div id="coll" class="coll-contents">
